#ifndef AMLIB_STATISTICS_UNIFORM_HISTOGRAM_H_
#define AMLIB_STATISTICS_UNIFORM_HISTOGRAM_H_
 ...
 *
 *****************************************************************************/
template<class Argument, class Bins>
inline decltype(auto)
begin(const uniform_histogram<Argument,Bins>& h)
{
    return h.begin();
}
//---------------------------------------------------------
template<class Argument, class Bins>
inline decltype(auto)
cbegin(const uniform_histogram<Argument,Bins>& h)
{
    return h.begin();
}
...
template<class Argument, class Bins>
inline decltype(auto)
end(const uniform_histogram<Argument,Bins>& h)
{
    return h.end();
}
//---------------------------------------------------------
template<class Argument, class Bins>
inline decltype(auto)
cend(const uniform_histogram<Argument,Bins>& h)
{
    return h.end();
}
...
template<class Argument, class Bins>
inline decltype(auto)
min(const uniform_histogram<Argument,Bins>& h)
{
    return h.min();
}
...
template<class Argument, class Bins>
inline decltype(auto)
max(const uniform_histogram<Argument,Bins>& h)
{
    return h.max();
}
...
//---------------------------------------------------------------
template<class Ostream, class Argument, class Bins>
Ostream&
operator << (Ostream& os, const uniform_histogram<Argument,Bins>& h)
{
    using size_t_ = typename uniform_histogram<Argument,Bins>::size_type;
...
template<class Ostream, class Argument, class Bins>
Ostream&
print(Ostream& os, const uniform_histogram<Argument,Bins>& h)
{
    using size_t_ = typename uniform_histogram<Argument,Bins>::size_type;
...
template<class Argument, class Bins>
auto
relative_frequencies(const uniform_histogram<Argument,Bins>& h)
{
    using fp_t = std::common_type_t<Argument,double>;

    auto res = std::vector<fp_t>{};
